...
STOCK_CONFIGS = {
    ...
    "3711": {'name': '日月光投控', 'industry': 'Semiconductor', 'us_chain_tickers': ['ASX', 'INTC', 'AMAT']},
    "3712": {'name': '永崴投控', 'industry': 'Energy', 'us_chain_tickers': ['TAN', 'FSLR']},
    "4104": {'name': '加捷', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "4106": {'name': '雃博', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "4119": {'name': '旭富', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "4126": {'name': '太醫', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "4137": {'name': '麗豐-KY', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "4147": {'name': '泰博', 'industry': 'Biotech', 'us_chain_tickers': ['TMO', 'DHR']},
    "4148": {'name': '全宇生技-KY', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "4162": {'name': '智擎', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI', 'PFE']},
    "4164": {'name': '承業醫', 'industry': 'Biotech', 'us_chain_tickers': ['TMO', 'DHR']},
    "4174": {'name': '浩鼎', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "4540": {'name': '全球傳動', 'industry': 'Robotics', 'us_chain_tickers': ['ABB', 'FANUY']},
    "4576": {'name': '大銀微系統', 'industry': 'Robotics', 'us_chain_tickers': ['ABB', 'FANUY']},
    "4583": {'name': '台灣精銳', 'industry': 'Robotics', 'us_chain_tickers': ['ABB', 'FANUY']},
    "4743": {'name': '合一', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI', 'LLY']},
    "4919": {'name': '新唐', 'industry': 'Semiconductor', 'us_chain_tickers': ['STM', 'IFX']},
    "4961": {'name': '天鈺', 'industry': 'Semiconductor', 'us_chain_tickers': ['VTI', 'SOXX']},
    "4966": {'name': '譜瑞-KY', 'industry': 'Semiconductor', 'us_chain_tickers': ['AAPL', 'INTC', 'QCOM']},
    "4968": {'name': '立積', 'industry': 'Semiconductor', 'us_chain_tickers': ['SWKS', 'QRVO']},
    "5269": {'name': '祥碩', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMD', 'INTC', 'AAPL']},
    "5274": {'name': '信驊', 'industry': 'Semiconductor', 'us_chain_tickers': ['ASPEED', 'NVDA', 'MSFT', 'AMZN']},
    "5347": {'name': '世界', 'industry': 'Semiconductor', 'us_chain_tickers': ['UMC', 'TXN']},
    "5434": {'name': '崇越', 'industry': 'Semiconductor', 'us_chain_tickers': ['SUMCO', 'Shin-Etsu']},
    "6120": {'name': '達運', 'industry': 'AI_Hardware', 'us_chain_tickers': ['VTI']},
    "6187": {'name': '萬潤', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'ASML', 'TSM']},
    "6223": {'name': '旺矽', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'AMAT']},
    "6274": {'name': '台燿', 'industry': 'AI_Hardware', 'us_chain_tickers': ['NVDA', 'AMD']},
    "6285": {'name': '啟碁', 'industry': 'Telecom', 'us_chain_tickers': ['CSCO', 'VTI']},
    ...
    "7699": {'name': '瑞利光', 'industry': 'Innovation', 'us_chain_tickers': ['VTI']},
    "7769": {'name': '鴻勁精密', 'industry': 'Innovation', 'us_chain_tickers': ['AMAT', 'ASML']},
    "7861": {'name': '貝爾威勒', 'industry': 'Innovation', 'us_chain_tickers': ['VTI']},
    "7869": {'name': '宏于電機', 'industry': 'Innovation', 'us_chain_tickers': ['ABB', 'GE']},
    "7883": {'name': '饗賓', 'industry': 'Retail', 'us_chain_tickers': ['VTI']},
    "8064": {'name': '東捷', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'ASML']},
    "8086": {'name': '宏捷科', 'industry': 'Semiconductor', 'us_chain_tickers': ['AVGO', 'QRVO', 'SWKS']},
    "8098": {'name': '慶康科技', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'TSM']},
    "8210": {'name': '勤誠', 'industry': 'AI_Hardware', 'us_chain_tickers': ['NVDA', 'MSFT', 'SMCI']},
},
    "1216": {'name': '統一', 'industry': 'Consumer', 'us_chain_tickers': ['VTI']},
    ...
    "1752": {'name': '南光', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "1760": {'name': '寶齡富錦', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI', 'PFE']},
    "1773": {'name': '勝一', 'industry': 'Materials', 'us_chain_tickers': ['AMAT', 'ASML']},
    "1786": {'name': '科妍', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "1795": {'name': '美時', 'industry': 'Biotech', 'us_chain_tickers': ['PFE', 'MRK']},
    "2002": {'name': '中鋼', 'industry': 'Materials', 'us_chain_tickers': ['X', 'NUE', 'STLD']},
    "2049": {'name': '上銀', 'industry': 'Robotics', 'us_chain_tickers': ['ABB', 'FANUY', 'KUKA']},
    "2105": {'name': '正新', 'industry': 'Materials', 'us_chain_tickers': ['GT', 'VTI']},
    "2106": {'name': '建大', 'industry': 'Materials', 'us_chain_tickers': ['GT', 'VTI']},
    ...
    "2338": {'name': '光罩', 'industry': 'Semiconductor', 'us_chain_tickers': ['TSM', 'UMC']},
    "2344": {'name': '華邦電', 'industry': 'Semiconductor', 'us_chain_tickers': ['MU', 'WDC', 'STX']},
    "2345": {'name': '智邦', 'industry': 'Telecom', 'us_chain_tickers': ['CSCO', 'NVDA']},
    "2352": {'name': '佳世達', 'industry': 'AI_Hardware', 'us_chain_tickers': ['PHG', 'GE']},
    "2353": {'name': '宏碁', 'industry': 'AI_Hardware', 'us_chain_tickers': ['INTC', 'MSFT']},
    "2357": {'name': '華碩', 'industry': 'AI_Hardware', 'us_chain_tickers': ['INTC', 'NVDA', 'AMD']},
    "2359": {'name': '所羅門', 'industry': 'Robotics', 'us_chain_tickers': ['NVDA', 'FANUY', 'ABB']},
    ...
    "2812": {'name': '台中銀', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2834": {'name': '臺企銀', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2880": {'name': '華南金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2881": {'name': '富邦金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'KBE', 'TNX']},
    "2882": {'name': '國泰金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'KBE', 'VTI']},
    "2883": {'name': '開發金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2884": {'name': '玉山金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2885": {'name': '元大金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'IAU']},
    "2886": {'name': '兆豐金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'KBE', 'TLT']},
    "2887": {'name': '台新金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2888": {'name': '新光金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2890": {'name': '永豐金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2891": {'name': '中信金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'VTI']},
    "2892": {'name': '第一金', 'industry': 'Finance', 'us_chain_tickers': ['XLF', 'TLT']},
    ...
    "3576": {'name': '聯合再生', 'industry': 'Energy', 'us_chain_tickers': ['TAN', 'FSLR']},
    "3583": {'name': '辛耘', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'ASML']},
    "3596": {'name': '智易', 'industry': 'Telecom', 'us_chain_tickers': ['CSCO', 'VTI']},
    "3653": {'name': '健策', 'industry': 'AI_Hardware', 'us_chain_tickers': ['NVDA', 'AMD']},
    "3661": {'name': '世芯-KY', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'AMZN', 'MSFT']},
    "3680": {'name': '家登', 'industry': 'Semiconductor', 'us_chain_tickers': ['ASML', 'TSM']},
    "3693": {'name': '營邦', 'industry': 'AI_Hardware', 'us_chain_tickers': ['SMCI', 'DELL']},
    ...
    "4576": {'name': '大銀微系統', 'industry': 'Robotics', 'us_chain_tickers': ['ABB', 'FANUY']},
    "4583": {'name': '台灣精銳', 'industry': 'Robotics', 'us_chain_tickers': ['ABB', 'FANUY']},
    "4721": {'name': '美琪瑪', 'industry': 'Materials', 'us_chain_tickers': ['ALB', 'SQM']},
    "4739": {'name': '康普', 'industry': 'Materials', 'us_chain_tickers': ['ALB', 'SQM']},
    "4743": {'name': '合一', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI', 'LLY']},
    "4770": {'name': '上品', 'industry': 'Materials', 'us_chain_tickers': ['AMAT', 'ASML']},
    "4919": {'name': '新唐', 'industry': 'Semiconductor', 'us_chain_tickers': ['STM', 'IFX']},
    "4961": {'name': '天鈺', 'industry': 'Semiconductor', 'us_chain_tickers': ['VTI', 'SOXX']},
    "4966": {'name': '譜瑞-KY', 'industry': 'Semiconductor', 'us_chain_tickers': ['AAPL', 'INTC', 'QCOM']},
    "4968": {'name': '立積', 'industry': 'Semiconductor', 'us_chain_tickers': ['SWKS', 'QRVO']},
    ...
    "6142": {'name': '友勁', 'industry': 'Telecom', 'us_chain_tickers': ['VTI']},
    "6176": {'name': '瑞儀', 'industry': 'AI_Hardware', 'us_chain_tickers': ['AAPL']},
    ...
    "6187": {'name': '萬潤', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'ASML', 'TSM']},
    "6202": {'name': '盛群', 'industry': 'Semiconductor', 'us_chain_tickers': ['VTI']},
    "6206": {'name': '飛捷', 'industry': 'Robotics', 'us_chain_tickers': ['VTI']},
    "6213": {'name': '聯茂', 'industry': 'AI_Hardware', 'us_chain_tickers': ['NVDA', 'AMD']},
    "6223": {'name': '旺矽', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'AMAT']},
    "6235": {'name': '華亞科', 'industry': 'Semiconductor', 'us_chain_tickers': ['MU']},
    "6239": {'name': '力成', 'industry': 'Semiconductor', 'us_chain_tickers': ['MU', 'INTC']},
    "6244": {'name': '茂迪', 'industry': 'Energy', 'us_chain_tickers': ['TAN', 'FSLR']},
    "6271": {'name': '同欣電', 'industry': 'Semiconductor', 'us_chain_tickers': ['ON', 'SONY']},
    "6274": {'name': '台燿', 'industry': 'AI_Hardware', 'us_chain_tickers': ['NVDA', 'AMD']},
    "6285": {'name': '啟碁', 'industry': 'Telecom', 'us_chain_tickers': ['CSCO', 'VTI']},
    "6412": {'name': '群聯', 'industry': 'Semiconductor', 'us_chain_tickers': ['WDC', 'MU']},
    "6414": {'name': '樺漢', 'industry': 'Robotics', 'us_chain_tickers': ['HON', 'ROK', 'NVDA']},
    "6415": {'name': '矽力*-KY', 'industry': 'Semiconductor', 'us_chain_tickers': ['MPS', 'TI', 'ADI']},
    "6446": {'name': '藥華藥', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI', 'MRK']},
    "6472": {'name': '保瑞', 'industry': 'Biotech', 'us_chain_tickers': ['PFE', 'MRK', 'AZN']},
    "6488": {'name': '環球晶', 'industry': 'Semiconductor', 'us_chain_tickers': ['WOLF', 'ON', 'SUMCO']},
    "6491": {'name': '晶碩', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "6504": {'name': '南六', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "6509": {'name': '聚和', 'industry': 'Materials', 'us_chain_tickers': ['ALB', 'SQM']},
    "6515": {'name': '穎崴', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'AMD']},
    "6531": {'name': '愛普*', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'TSM', 'SOXX']},
    "6547": {'name': '高端疫苗', 'industry': 'Biotech', 'us_chain_tickers': ['MRNA', 'BNTX']},
    "6643": {'name': 'M31', 'industry': 'Semiconductor', 'us_chain_tickers': ['SNPS', 'CDNS', 'ARM']},
    "6669": {'name': '緯穎', 'industry': 'AI_Hardware', 'us_chain_tickers': ['MSFT', 'META', 'AMZN', 'NVDA']},
    "6683": {'name': '雍智科技', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'AMD']},
    "6703": {'name': '長聖', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "6781": {'name': 'AES-KY', 'industry': 'Energy', 'us_chain_tickers': ['TSLA', 'BYDDF']},
    "6782": {'name': '視陽', 'industry': 'Biotech', 'us_chain_tickers': ['VTI']},
    "6789": {'name': '采鈺', 'industry': 'Semiconductor', 'us_chain_tickers': ['TSM', 'SONY']},
    "6805": {'name': '富世達', 'industry': 'AI_Hardware', 'us_chain_tickers': ['AAPL']},
    "6806": {'name': '森崴能源', 'industry': 'Energy', 'us_chain_tickers': ['TAN', 'FSLR', 'ENPH']},
    "6826": {'name': '和淞', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'ASML']},
    "6854": {'name': '泓德能源', 'industry': 'Energy', 'us_chain_tickers': ['TAN', 'FSLR', 'ENPH']},
    "6861": {'name': '睿光生電', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "6869": {'name': '雲豹能源', 'industry': 'Energy', 'us_chain_tickers': ['TAN', 'FSLR', 'ENPH']},
    "6901": {'name': '鑽石生技', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "6919": {'name': '康霈*', 'industry': 'Biotech', 'us_chain_tickers': ['IBB', 'XBI']},
    "6977": {'name': '聯純', 'industry': 'Materials', 'us_chain_tickers': ['VTI']},
    "7403": {'name': '紐因科技', 'industry': 'Innovation', 'us_chain_tickers': ['VTI']},
    "7408": {'name': '易得雲端', 'industry': 'Innovation', 'us_chain_tickers': ['VTI']},
    ...
    "7869": {'name': '宏于電機', 'industry': 'Innovation', 'us_chain_tickers': ['ABB', 'GE']},
    "7883": {'name': '饗賓', 'industry': 'Retail', 'us_chain_tickers': ['VTI']},
    "8016": {'name': '矽創', 'industry': 'Semiconductor', 'us_chain_tickers': ['VTI', 'SOXX']},
    "8028": {'name': '昇陽半導體', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'TSM']},
    "8046": {'name': '南電', 'industry': 'Semiconductor', 'us_chain_tickers': ['NVDA', 'AMD', 'SOXX']},
    "8064": {'name': '東捷', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'ASML']},
    "8081": {'name': '致新', 'industry': 'Semiconductor', 'us_chain_tickers': ['TI', 'ADI']},
    "8086": {'name': '宏捷科', 'industry': 'Semiconductor', 'us_chain_tickers': ['AVGO', 'QRVO', 'SWKS']},
    "8098": {'name': '慶康科技', 'industry': 'Semiconductor', 'us_chain_tickers': ['AMAT', 'TSM']},
    "8210": {'name': '勤誠', 'industry': 'AI_Hardware', 'us_chain_tickers': ['NVDA', 'MSFT', 'SMCI']},
    "8213": {'name': '志超', 'industry': 'AI_Hardware', 'us_chain_tickers': ['DELL', 'HPQ']},
    "8234": {'name': '新漢', 'industry': 'Robotics', 'us_chain_tickers': ['NVDA', 'ROK']},
    "8299": {'name': '群聯', 'industry': 'Semiconductor', 'us_chain_tickers': ['MU', 'WDC', 'STX']},
    "8404": {'name': '百和', 'industry': 'Retail', 'us_chain_tickers': ['NKE']},
    "9904": {'name': '寶成', 'industry': 'Retail', 'us_chain_tickers': ['NKE', 'ADDYY']},
    "9910": {'name': '豐泰', 'industry': 'Retail', 'us_chain_tickers': ['NKE']},
    "9914": {'name': '美利達', 'industry': 'Retail', 'us_chain_tickers': ['VTI']},
    "9921": {'name': '巨大', 'industry': 'Retail', 'us_chain_tickers': ['VTI']},
},
    "1301": {'name': '台塑', 'industry': 'Materials', 'us_chain_tickers': ['DOW', 'LYB', 'XOM']},
    "1303": {'name': '南亞', 'industry': 'Materials', 'us_chain_tickers': ['DOW', 'LYB', 'XOM']},
    "1503": {'name': '士電', 'industry': 'AI_Hardware', 'us_chain_tickers': ['ETN', 'PWR', 'GE']},
