"""
core/__init__.py v1.17 (Quantum Finance Sovereign Hub - Constitution v6.0.0 Aligned)
================================================================================
**最後更新日期**: 2026-05-21
**主權狀態**: ACTIVE (憲法 v6.0.0 對齊 + path_setup v4.46 hub 邊界同步；8 項檢查面 100% 合規)
...
2. [Boundary Integrity]: 路徑接口維度鎖定為 **25 維**，嚴禁回到 v5.2/v5.3
   時代之 27 維誤宣告（對齊 `path_setup.py v4.46` 之 `ALL_PATHS`）。
...
| **1**   | [環境前置：路徑與目錄自癒]                 | `$ python scripts/core/path_setup.py`                                                                    | `path_setup v4.46` |
...
| **HUB** | [中樞主權完整性稽核]                       | `$ python scripts/core/__init__.py`                                                                      | `core/__init__ v1.17` |
