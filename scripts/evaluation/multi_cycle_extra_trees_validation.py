"""
multi_cycle_extra_trees_validation.py v0.2 (Multi-Cycle Extra Trees Validation + Precision/Reliability Analysis · §14.7-CY 第六實作 · per Canonical Comparison Framework · per CLAUDE.md §一.11 三段式入憲)
================================================================================
**最後更新日期**: 2026-06-02
**主權狀態**: MULTI-CYCLE 4-HORIZON EXTRA TREES VALIDATION + PRECISION/RELIABILITY + CANONICAL COMPARISON FRAMEWORK + §14.7-CY HORIZON-EXTENSION + §14.7-CX 8-YEAR OOS + §14.7-CW TREE-FAMILY 第六實作 + §一.10 SOURCE-TRACEABLE + §一.11 三段式合規 + §14.7-DE/DF §0.0-I 雙 helper 切換(2026-06-02)
**最高原則**: THE SUPREME AUTHORITY PRINCIPLE (最高權限原則)

## 🎯 零、這支程式在做什麼(白話說明,給人看的)

**一句話**:用 Extra Trees(極端隨機樹) 模型,實測「靠過去的股票特徵能不能預測未來、選股賺錢」,並給出「賺多少 / 準不準 / 可不可信」的成績單。
...
| v0.1 | 2026-05-29 | Codex | **首版:§14.7-CY 第六實作(Extra Trees)**。 (1) 4-horizon walk-forward,sklearn ExtraTreesRegressor;(2) Canonical Comparison Framework 對齊;(3) ET vs RF pairwise ablation(bagging 家族第二實作);(4) Precision/Reliability 新層延續其他 multi-cycle validators。 | SUPERSEDED |
"""
...
def main():
    ...
    ET_PARAMS["random_state"] = args.seed; globals()["SEED"] = args.seed  # §一.10 #3: inject run seed
