"""
multi_cycle_itransformer_validation.py v0.1 (iTransformer · Inverted Transformer · ICLR 2024 / Liu et al. · Multi-Cycle Stock-Price Validation · per CLAUDE.md §一.11 三段式)
================================================================================
**最後更新日期**: 2026-05-30
**主權狀態**: iTRANSFORMER(INVERTED TRANSFORMER / ICLR 2024)4-HORIZON WALK-FORWARD VALIDATION + §14.7-CY HORIZON-DOCTRINE 第二族(neural)+ §14.7-DC v0.18 SOURCE-PURE UNIVERSE + §一.10 SOURCE-TRACEABLE(全 DB)+ §一.10 #3 MULTI-RUN + 共同比較基準(COMMON COMPARISON BASELINE)第二實作 + §一.11 三段式合規
