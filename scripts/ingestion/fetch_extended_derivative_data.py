"""
fetch_extended_derivative_data.py v5.5.7 (Trinity Core Final)
================================================================================
資料抓取模組 — 混合模式日誌實作版
...
2. 大規模並行抓取 (透過調度器對全市場執行)：
   ...
   from ingestion.fetch_extended_derivative_data import fetch_ext_deriv
   from core.db_utils import get_db_stock_ids
   
   # 啟動並行調度：對全市場標的執行 fetch_ext_deriv
   run_orchestrator(fetch_ext_deriv, get_db_stock_ids(), "all_market_fetch_ext_deriv")
   ------------------------------------------------------------
"""
