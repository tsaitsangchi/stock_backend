"""
fetch_stock_info.py v5.5.7 (Trinity Core Final)
================================================================================
資料抓取模組 — 混合模式日誌實作版
...
2. 大規模並行抓取 (透過調度器對全市場執行)：
   ...
   from ingestion.fetch_stock_info import fetch_info
   from core.db_utils import get_db_stock_ids
   
   # 啟動並行調度：對全市場標的執行 fetch_info
   run_orchestrator(fetch_info, get_db_stock_ids(), "all_market_fetch_info")
   ------------------------------------------------------------
"""
