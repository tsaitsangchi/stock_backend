"""
fetch_news_data.py v5.5.7 (Trinity Core Final)
================================================================================
資料抓取模組 — 混合模式日誌實作版
...
1. 手動單點調試 (僅抓取台積電 2330 作為測試)：
   $ python scripts/ingestion/fetch_news_data.py
...
2. 大規模並行抓取 (透過調度器對全市場執行)：
   ...
   # 啟動並行調度：對全市場標的執行 fetch_news
   run_orchestrator(fetch_news, get_db_stock_ids(), "all_market_fetch_news")
   ------------------------------------------------------------
"""
