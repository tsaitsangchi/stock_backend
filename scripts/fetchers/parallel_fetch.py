...
"""
parallel_fetch.py — 並行資料抓取管理器 (架構遷移適配版)
...
# 路徑與模組設定
# ─────────────────────────────────────────────
SCRIPTS_DIR = Path(__file__).resolve().parent  # scripts/fetchers
...
# ─────────────────────────────────────────────
# 腳本清單（使用絕對路徑，指向同目錄下的 fetcher 腳本）
# ─────────────────────────────────────────────
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("   並行資料抓取管線 (子目錄適配版) 啟動")
    logger.info("=" * 60)
