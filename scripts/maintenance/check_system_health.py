...
| 版本 | 日期 | 修訂者 | 修訂說明 | 治權狀態 |
| :--- | :--- | :--- | :--- | :--- |
| **v2.32** | 2026-05-12 | Antigravity | **憲法終極校準**：補全全量維運矩陣與「範例窮舉說明」，對齊 v5.2 旗艦版標準。 | **ACTIVE** |
| v2.31 | 2026-05-12 | Antigravity | **治權完備化**：補全全場景健康維運矩陣，落實「系統治權健康條約」，對齊 v5.2 標準。 | SUPERSEDED |
