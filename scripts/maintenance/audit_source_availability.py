"""
audit_source_availability.py v0.6 (Strict Source Availability Audit · §6.8.8-C Time-Drift Tolerance · §6.8.8-D Full-Market Mode · §0.4 Progress Heartbeat · §6.8.8-E Quota-Error Detection · §14.7-AS Time-Drift Hotfix)
================================================================================
**最後更新日期**: 2026-05-22
**主權狀態**: ACTIVE (憲法 v6.0.0 §14.7-L 對齊 + §6.8.8-C 時點漂移容忍規則落地 + §14.7-AP 治權閉環 + §6.8.8-D 全市場驗證模式 + §14.7-AQ 範圍對稱性補齊 + §0.4 [Hybrid Observability] 進度心跳 + §6.8.8-E Quota-Error 分類 + §14.7-AR 錯誤分類治權補齊 + §14.7-AS `_is_time_drift_ok` 字串減法 latent bug hotfix)
