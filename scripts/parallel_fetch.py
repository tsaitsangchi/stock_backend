...
# Phase 1：並行執行各類資料
PHASE_1 = [
    str(SCRIPTS_DIR / "fetch_technical_data.py"),          # 股價、PER（Batch 模式）
    str(SCRIPTS_DIR / "fetch_chip_data.py"),               # 三大法人、融資融券
...
def main():
    ...
    # ── Phase 1：並行執行其餘腳本
    logger.info(f"\n[Phase 1] 啟動並行資料抓取（並行數: {MAX_WORKERS}）…")
