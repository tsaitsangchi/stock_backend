"""
pipeline/feature_engineering.py v6 (特徵工程(pipeline/))
================================================================================
**最後更新日期**: 2026-06-02
...
**一句話**:特徵工程:加技術 / 籌碼 / 基本面 / 估值特徵(pipeline/ 版,被 data_pipeline 用)。

**輸入 → 輸出**:raw 資料 → 加工特徵 DataFrame

**為什麼需要它**:data_pipeline backtest 子系統之特徵生成。
