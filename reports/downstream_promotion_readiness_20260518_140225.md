...
- **PASS** `committed_model_cardinality`: current prediction-backed model=mdl_20260425_lgbm_h20_d969ffb1_v0_1; committed_model_count=13; historical walk-forward models allowed
- **PASS** `model_id_governance`: all committed model_ids include feature_set_version hash: count=13
- **FAIL** `label_horizon`: bad horizons=[('mdl_20260331_lgbm_h30_e5d97ec0_v0_1', 30)], expected 20
- **FAIL** `model_data_cutoff`: cutoff violations=[('mdl_20260331_lgbm_h30_e5d97ec0_v0_1', 'missing_or_bad_horizon', datetime.date(2026, 4, 30))]
- **PASS** `model_quality`: all committed models have ic_mean > 0: count=13; current_trainer=robust_rank_ic_baseline_v0.1
- **PASS** `model_artifact`: all committed model artifacts exist: count=13
