...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=260 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=16317 |
| DB-Schema | TaiwanStockPrice | ✅ PASS | 10 columns matched; rows=10477552 |
| DB-Schema | TaiwanStockPriceAdj | ✅ PASS | 10 columns matched; rows=10475510 |
| DB-Schema | TaiwanStockPER | ✅ PASS | 5 columns matched; rows=7324811 |
| DB-Schema | TaiwanStockInstitutionalInvestorsBuySell | ✅ PASS | 5 columns matched; rows=22734797 |
| DB-Schema | TaiwanStockMarginPurchaseShortSale | ✅ PASS | 16 columns matched; rows=500876 |
| DB-Schema | TaiwanStockShareholding | ✅ PASS | 13 columns matched; rows=545826 |
| DB-Schema | TaiwanStockFinancialStatements | ✅ PASS | 5 columns matched; rows=180625 |
| DB-Schema | TaiwanStockMonthRevenue | ✅ PASS | 7 columns matched; rows=29847 |
| DB-Schema | TaiwanStockDividend | ✅ PASS | 22 columns matched; rows=2027 |
...
| Freshness | FRED/DFF | ✅ PASS | latest=2026-05-14, age=5d |
| Freshness | FRED/UNRATE | ✅ PASS | latest=2026-04-01, age=48d |
| Freshness | FRED/T10Y2Y | ✅ PASS | latest=2026-05-15, age=4d |
| Freshness | FRED/VIXCLS | ✅ PASS | latest=2026-05-14, age=5d |
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=260 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=16317 |
| Pipeline-Log | task_status | ❌ FAILED | audit_downstream_readiness_v0.1=failed; audit_leakage_v0.1=failed; audit_downstream_readiness_v0.1=failed |
| Pipeline-Log | end_time | ✅ PASS | 177 recent tasks have end_time |
