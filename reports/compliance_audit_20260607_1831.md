...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=177 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=41936 |
...
| Freshness | FRED/DFF | ✅ PASS | latest=2026-06-04, age=3d |
| Freshness | FRED/UNRATE | ✅ PASS | latest=2026-05-01, age=37d |
| Freshness | FRED/T10Y2Y | ✅ PASS | latest=2026-06-05, age=2d |
| Freshness | FRED/VIXCLS | ✅ PASS | latest=2026-06-04, age=3d |
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=177 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=41936 |
| Pipeline-Log | task_status | ❌ FAILED | audit_source_availability_full=failed; post_schema_audit_v1.19=failed |
