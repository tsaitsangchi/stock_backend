...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=142 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=35530 |
...
| DB-Schema | FredData | ✅ PASS | 5 columns matched; rows=48903 |
| DB-Schema | TaiwanStockInfo | ✅ PASS | 5 columns matched; rows=2806 |
| DB-FRED | completeness | ✅ PASS | series counts={'DFF': 26269, 'UNRATE': 939, 'T10Y2Y': 12497, 'VIXCLS': 9198} |
| Freshness | FRED/DFF | ✅ PASS | latest=2026-06-01, age=2d |
| Freshness | FRED/UNRATE | ⚠️ STALE | latest=2026-04-01, age=63d, threshold=60d |
| Freshness | FRED/T10Y2Y | ✅ PASS | latest=2026-06-02, age=1d |
| Freshness | FRED/VIXCLS | ✅ PASS | latest=2026-06-01, age=2d |
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=142 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=35530 |
| Pipeline-Log | task_status | ❌ FAILED | api_schema_compliance_audit_v0.6=failed |
| Pipeline-Log | end_time | ✅ PASS | 17 recent tasks have end_time |
