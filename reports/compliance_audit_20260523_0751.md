...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=9 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=22073 |
| DB-Schema | TaiwanStockPrice | ✅ PASS | 10 columns matched; rows=10509879 |
| DB-Schema | TaiwanStockPriceAdj | ✅ PASS | 10 columns matched; rows=10507832 |
| DB-Schema | TaiwanStockPER | ✅ PASS | 5 columns matched; rows=7346851 |
| DB-Schema | TaiwanStockInstitutionalInvestorsBuySell | ✅ PASS | 5 columns matched; rows=25014641 |
| DB-Schema | TaiwanStockMarginPurchaseShortSale | ✅ PASS | 16 columns matched; rows=7717343 |
| DB-Schema | TaiwanStockShareholding | ✅ PASS | 13 columns matched; rows=8372856 |
| DB-Schema | TaiwanStockFinancialStatements | ✅ PASS | 5 columns matched; rows=2663194 |
...
| DB-Schema | FredData | ✅ PASS | 5 columns matched; rows=48879 |
| DB-Schema | TaiwanStockInfo | ✅ PASS | 5 columns matched; rows=2803 |
| DB-FRED | completeness | ✅ PASS | series counts={'DFF': 26258, 'T10Y2Y': 12491, 'UNRATE': 939, 'VIXCLS': 9191} |
| Freshness | FRED/DFF | ✅ PASS | latest=2026-05-21, age=2d |
| Freshness | FRED/UNRATE | ✅ PASS | latest=2026-04-01, age=52d |
| Freshness | FRED/T10Y2Y | ✅ PASS | latest=2026-05-22, age=1d |
| Freshness | FRED/VIXCLS | ✅ PASS | latest=2026-05-21, age=2d |
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=9 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=22073 |
| Pipeline-Log | task_status | ✅ PASS | 9 recent tasks have acceptable status |
| Pipeline-Log | end_time | ✅ PASS | 9 recent tasks have end_time |
