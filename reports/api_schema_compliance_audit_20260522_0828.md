...
| G | Date Series Continuity | 7 | 4 | FAIL |
| H | Referential Integrity | 9 | 0 | PASS |
| I | Value Range Sanity | 7 | 1 | FAIL |
...
- ✅ [C] TaiwanStockInfo.stock_name: max length 14 ≤ 255
...
- PASS=11, FAIL=0
- ✅ [E] TaiwanStockPrice.date,stock_id: unique 一致：10485300 rows
- ✅ [E] TaiwanStockPriceAdj.date,stock_id: unique 一致：10480920 rows
- ✅ [E] TaiwanStockPER.date,stock_id: unique 一致：7328734 rows
- ✅ [E] TaiwanStockInstitutionalInvestorsBuySell.date,stock_id,name: unique 一致：24963205 rows
- ✅ [E] TaiwanStockMarginPurchaseShortSale.date,stock_id: unique 一致：7695882 rows
- ✅ [E] TaiwanStockShareholding.date,stock_id: unique 一致：8352856 rows
- ✅ [E] TaiwanStockFinancialStatements.date,stock_id,type,origin_name: unique 一致：2656263 rows
- ✅ [E] TaiwanStockMonthRevenue.date,stock_id: unique 一致：459383 rows
- ✅ [E] TaiwanStockDividend.date,stock_id,year: unique 一致：29262 rows
- ✅ [E] FredData.date,series_id: unique 一致：48873 rows
- ✅ [E] TaiwanStockInfo.stock_id: unique 一致：2799 rows

### Layer F: Duplicate Row Detection

- PASS=13, FAIL=0
- ✅ [F] pipeline_execution_log.row: 無重複：13 rows
- ✅ [F] data_audit_log.row: 無重複：22579 rows
- ✅ [F] TaiwanStockPrice.row: 無重複：10485300 rows
- ✅ [F] TaiwanStockPriceAdj.row: 無重複：10480920 rows
- ✅ [F] TaiwanStockPER.row: 無重複：7328734 rows
- ✅ [F] TaiwanStockInstitutionalInvestorsBuySell.row: 無重複：24963205 rows
- ✅ [F] TaiwanStockMarginPurchaseShortSale.row: 無重複：7695882 rows
- ✅ [F] TaiwanStockShareholding.row: 無重複：8352856 rows
- ✅ [F] TaiwanStockFinancialStatements.row: 無重複：2656263 rows
- ✅ [F] TaiwanStockMonthRevenue.row: 無重複：459383 rows
- ✅ [F] TaiwanStockDividend.row: 無重複：29262 rows
- ✅ [F] FredData.row: 無重複：48873 rows
- ✅ [F] TaiwanStockInfo.row: 無重複：2799 rows

### Layer G: Date Series Continuity

- PASS=7, FAIL=4
- ✅ [G] TaiwanStockPrice.date: date 連續性正常：1992-01-04~2026-05-21, 8767 個 distinct dates (~8969 工作日預期)
- ✅ [G] TaiwanStockPriceAdj.date: date 連續性正常：1992-01-04~2026-05-21, 8767 個 distinct dates (~8969 工作日預期)
- ✅ [G] TaiwanStockPER.date: date 連續性正常：2005-09-02~2026-05-20, 5095 個 distinct dates (~5404 工作日預期)
- ✅ [G] TaiwanStockInstitutionalInvestorsBuySell.date: date 連續性正常：2005-01-03~2026-05-21, 5258 個 distinct dates (~5577 工作日預期)
- ✅ [G] TaiwanStockMarginPurchaseShortSale.date: date 連續性正常：2001-01-05~2026-05-20, 6248 個 distinct dates (~6619 工作日預期)
- ✅ [G] TaiwanStockShareholding.date: date 連續性正常：2004-02-12~2026-05-20, 5525 個 distinct dates (~5810 工作日預期)
- ❌ [G] TaiwanStockFinancialStatements.date: date 連續性低：1990-03-31~2026-03-31 範圍 13150 天，預期工作日 ~9392，實際 145
- ❌ [G] TaiwanStockMonthRevenue.date: date 連續性低：2002-02-01~2026-05-01 範圍 8856 天，預期工作日 ~6325，實際 292
- ❌ [G] TaiwanStockDividend.date: date 連續性低：2005-05-23~2026-08-15 範圍 7755 天，預期工作日 ~5539，實際 4254
- ✅ [G] FredData.date: date 連續性正常：1948-01-01~2026-05-20, 26335 個 distinct dates (~20450 工作日預期)
- ❌ [G] TaiwanStockInfo.date: date 連續性低：2026-04-21~2026-05-21 範圍 31 天，預期工作日 ~22，實際 16
...
- ❌ [I] TaiwanStockMonthRevenue.revenue: revenue < 0：640 rows
