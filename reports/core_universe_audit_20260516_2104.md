...
| PASS | `snapshot_resolve` | snapshot=core_universe_20260514_core_universe_policy_v0_2, status=committed |
...
| FAIL | `pending_scores_boundary` | pending score columns unexpectedly populated rows=2799 |
| FAIL | `score_scope` | score_detail scope mismatches=2799 |
| PASS | `revision_log` | BUILD_SNAPSHOT revision rows=4 |
| PASS | `data_audit_log` | CORE_UNIVERSE_BUILD audit rows=5 |
| FAIL | `pipeline_lifecycle` | core_universe_builder success lifecycle row missing |
