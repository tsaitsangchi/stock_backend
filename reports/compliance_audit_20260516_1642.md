...
| 來源層 | 項目 | 狀態 | 詳細 |
| :--- | :--- | :--- | :--- |
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=25 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=53 |
...
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=25 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=53 |
| Pipeline-Log | task_status | ✅ PASS | 25 recent tasks have acceptable status |
| Pipeline-Log | end_time | ✅ PASS | 25 recent tasks have end_time |
