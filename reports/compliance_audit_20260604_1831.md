...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=165 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=37142 |
...
| DB-Schema | FredData | ✅ PASS | 5 columns matched; rows=48906 |
| DB-Schema | TaiwanStockInfo | ✅ PASS | 5 columns matched; rows=2806 |
| DB-FRED | completeness | ✅ PASS | series counts={'DFF': 26270, 'T10Y2Y': 12498, 'UNRATE': 939, 'VIXCLS': 9199} |
| Freshness | FRED/DFF | ✅ PASS | latest=2026-06-02, age=2d |
| Freshness | FRED/UNRATE | ⚠️ STALE | latest=2026-04-01, age=64d, threshold=60d |
| Freshness | FRED/T10Y2Y | ✅ PASS | latest=2026-06-03, age=1d |
| Freshness | FRED/VIXCLS | ✅ PASS | latest=2026-06-02, age=2d |
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=165 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=37142 |
| Pipeline-Log | task_status | ✅ PASS | 22 recent tasks have acceptable status |
| Pipeline-Log | end_time | ✅ PASS | 22 recent tasks have end_time |
