...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=72 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=2851 |
| DB-Schema | TaiwanStockPrice | ✅ PASS | 10 columns matched; rows=670453 |
| DB-Schema | TaiwanStockPriceAdj | ✅ PASS | 10 columns matched; rows=670321 |
| DB-Schema | TaiwanStockPER | ✅ PASS | 5 columns matched; rows=507498 |
| DB-Schema | TaiwanStockInstitutionalInvestorsBuySell | ✅ PASS | 5 columns matched; rows=1745705 |
...
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=72 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=2851 |
| Pipeline-Log | task_status | ❌ FAILED | audit_downstream_readiness_v0.1=failed |
| Pipeline-Log | end_time | ✅ PASS | 72 recent tasks have end_time |
