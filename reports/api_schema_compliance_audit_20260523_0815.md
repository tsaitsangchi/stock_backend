...
- PASS=11, FAIL=0
- ✅ [E] TaiwanStockPrice.date,stock_id: unique 一致：10509879 rows
- ✅ [E] TaiwanStockPriceAdj.date,stock_id: unique 一致：10507832 rows
- ✅ [E] TaiwanStockPER.date,stock_id: unique 一致：7346851 rows
- ✅ [E] TaiwanStockInstitutionalInvestorsBuySell.date,stock_id,name: unique 一致：25014641 rows
- ✅ [E] TaiwanStockMarginPurchaseShortSale.date,stock_id: unique 一致：7717343 rows
- ✅ [E] TaiwanStockShareholding.date,stock_id: unique 一致：8372856 rows
- ✅ [E] TaiwanStockFinancialStatements.date,stock_id,type,origin_name: unique 一致：2663194 rows
- ✅ [E] TaiwanStockMonthRevenue.date,stock_id: unique 一致：460187 rows
- ✅ [E] TaiwanStockDividend.date,stock_id,year: unique 一致：29312 rows
- ✅ [E] FredData.date,series_id: unique 一致：48879 rows
- ✅ [E] TaiwanStockInfo.stock_id: unique 一致：2803 rows

### Layer F: Duplicate Row Detection

- PASS=13, FAIL=0
- ✅ [F] pipeline_execution_log.row: 無重複：10 rows
- ✅ [F] data_audit_log.row: 無重複：22073 rows
- ✅ [F] TaiwanStockPrice.row: 無重複：10509879 rows
- ✅ [F] TaiwanStockPriceAdj.row: 無重複：10507832 rows
- ✅ [F] TaiwanStockPER.row: 無重複：7346851 rows
- ✅ [F] TaiwanStockInstitutionalInvestorsBuySell.row: 無重複：25014641 rows
- ✅ [F] TaiwanStockMarginPurchaseShortSale.row: 無重複：7717343 rows
- ✅ [F] TaiwanStockShareholding.row: 無重複：8372856 rows
- ✅ [F] TaiwanStockFinancialStatements.row: 無重複：2663194 rows
- ✅ [F] TaiwanStockMonthRevenue.row: 無重複：460187 rows
- ✅ [F] TaiwanStockDividend.row: 無重複：29312 rows
- ✅ [F] FredData.row: 無重複：48879 rows
- ✅ [F] TaiwanStockInfo.row: 無重複：2803 rows
