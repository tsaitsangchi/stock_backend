...
- generated_at: 2026-05-17 09:01:08
...
- **PASS** `committed_model_cardinality`: model=mdl_20250425_lgbm_h20_5c7f36c2_v0_1
- **PASS** `model_id_governance`: model_id includes feature_set_version hash
- **PASS** `label_horizon`: horizon=20
- **PASS** `model_data_cutoff`: label_date_max=2025-05-15 <= 2025-05-15
- **PASS** `model_quality`: ic_mean=0.491110, trainer=robust_rank_ic_baseline_v0.1
- **PASS** `model_artifact`: data/models/mdl_20250425_lgbm_h20_5c7f36c2_v0_1/model.json exists
