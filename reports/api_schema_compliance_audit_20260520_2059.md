...
| B | API Sample ↔ DDL Type Compatibility | 101 | 1 | FAIL |
...
- ✅ [A] TaiwanStockMonthRevenue.create_time: timestamp without time zone 對齊
...
- ❌ [B] TaiwanStockMonthRevenue.create_time: cast 失敗 3/3（DDL TIMESTAMP）
...
- PASS=13, FAIL=0
- ✅ [F] pipeline_execution_log.row: 無重複：0 rows
- ✅ [F] data_audit_log.row: 無重複：11 rows
