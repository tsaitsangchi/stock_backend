...
- **時間**: 2026-05-16 21:08:54
- **憲章**: 系統架構大憲章_v5.4.22.md
- **稽核工具**: audit_supply_chain v1.18
- **schema 基準**: data_schema v2.11
- **判定結果**: **FAILED** (PASS=21, WARN=0, FAIL=1)

## 稽核明細

| 來源層 | 項目 | 狀態 | 詳細 |
| :--- | :--- | :--- | :--- |
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=14 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=38 |
...
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=14 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=38 |
| Pipeline-Log | task_status | ❌ FAILED | audit_core_universe_v0.1=failed; audit_core_universe_v0.1=failed |
| Pipeline-Log | end_time | ✅ PASS | 14 recent tasks have end_time |
