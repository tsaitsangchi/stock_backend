...
- generated_at: 2026-05-18 14:03:54
...
- **PASS** `label_horizon`: all committed models horizon ∈ {20/30}: count=13
- **PASS** `model_data_cutoff`: historical label_date_max <= db max_price_date=2026-05-15; production-current uses required_label_date gate: historical=13, production_current=0
