...
| 來源層 | 項目 | 狀態 | 詳細 |
| :--- | :--- | :--- | :--- |
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=18 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=37 |
...
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=18 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=37 |
| Pipeline-Log | task_status | ✅ PASS | 18 recent tasks have acceptable status |
| Pipeline-Log | end_time | ✅ PASS | 18 recent tasks have end_time |
