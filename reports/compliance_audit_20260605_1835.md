...
| DB-Schema | pipeline_execution_log | ✅ PASS | 9 columns matched; rows=169 |
| DB-Schema | data_audit_log | ✅ PASS | 7 columns matched; rows=38740 |
...
| DB-Schema | TaiwanStockMarginPurchaseShortSale | ✅ PASS | 16 columns matched; rows=7726104 |
...
| DB-Schema | FredData | ✅ PASS | 5 columns matched; rows=48909 |
| DB-Schema | TaiwanStockInfo | ✅ PASS | 5 columns matched; rows=2806 |
| DB-FRED | completeness | ✅ PASS | series counts={'DFF': 26271, 'T10Y2Y': 12499, 'UNRATE': 939, 'VIXCLS': 9200} |
| Freshness | FRED/DFF | ✅ PASS | latest=2026-06-03, age=2d |
| Freshness | FRED/UNRATE | ⚠️ STALE | latest=2026-04-01, age=65d, threshold=60d |
| Freshness | FRED/T10Y2Y | ✅ PASS | latest=2026-06-04, age=1d |
| Freshness | FRED/VIXCLS | ✅ PASS | latest=2026-06-03, age=2d |
| Log-Schema | pipeline_execution_log | ✅ PASS | exists; rows=169 |
| Log-Schema | data_audit_log | ✅ PASS | exists; rows=38740 |
