...
- constitution: v6.1.0
- snapshot_id: core_universe_20260521_core_universe_policy_v0_2
...
| PASS | `snapshot_resolve` | snapshot=core_universe_20260521_core_universe_policy_v0_2, status=committed |
...
| PASS | `tier_count` | research_universe=2239 matches snapshot.research_count |
...
| PASS | `v02_scores_boundary` | six-layer score columns populated rows=2767 (policy=core_universe_policy_v0.2) |
| PASS | `score_scope` | all score_detail records declare v0.2_six_layer |
| PASS | `score_detail_keys` | policy=core_universe_policy_v0.2 has no sub-score detail expectation (baseline) |
