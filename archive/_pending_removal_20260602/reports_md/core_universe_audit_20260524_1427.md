...
- constitution: v6.0.0
- snapshot_id: core_universe_20260524_core_universe_policy_v0_2
...
| PASS | `snapshot_resolve` | snapshot=core_universe_20260524_core_universe_policy_v0_2, status=committed |
...
| PASS | `membership_count` | membership_count=2771 matches snapshot.total_candidates |
| PASS | `scores_count` | scores_count=2771 matches snapshot.total_candidates |
| PASS | `tier_allowed` | all membership tiers are governed tiers |
| PASS | `tier_count` | research_universe=2243 matches snapshot.research_count |
...
| PASS | `downstream_eligibility_boundary` | all downstream eligibility flags remain false across 2771 rows |
| PASS | `v02_scores_boundary` | v0.2 six-layer score columns populated rows=2771 |
