...
| PASS | `revision_log` | BUILD_SNAPSHOT revision rows=4 |
| PASS | `data_audit_log` | CORE_UNIVERSE_BUILD audit rows=20 |
| PASS | `pipeline_lifecycle` | core_universe_builder accepted lifecycle rows=6 |
