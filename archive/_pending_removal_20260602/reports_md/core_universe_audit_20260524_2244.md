...
- constitution: v6.0.0
- snapshot_id: core_universe_20260522_core_universe_policy_v0_3
- as_of_date: 2026-05-22
- policy_version: core_universe_policy_v0.3
- verdict: PERFECT
...
| PASS | `snapshot_resolve` | snapshot=core_universe_20260522_core_universe_policy_v0_3, status=committed |
| PASS | `snapshot_status` | snapshot status is committed |
| PASS | `policy` | policy_version=core_universe_policy_v0.3 active |
...
| PASS | `policy_score_config` | v0.3 policy uses six-layer CoreScore weights with FG extended sub-scores (gross_margin + ROE) |
...
| PASS | `v02_scores_boundary` | six-layer score columns populated rows=2803 (policy=core_universe_policy_v0.3) |
| PASS | `score_scope` | all score_detail records declare v0.3_six_layer_extended |
| PASS | `revision_log` | BUILD_SNAPSHOT revision rows=3 |
| PASS | `data_audit_log` | CORE_UNIVERSE_BUILD audit rows=15 |
| PASS | `pipeline_lifecycle` | core_universe_builder accepted lifecycle rows=5 |
