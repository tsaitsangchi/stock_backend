...
**SPEC 演進**:
- 原 SPEC_43(含 211 imputed + theme_strength + fitness_signal_60d + theme_is_semiconductor)
- v0.17 SPEC_43 - 211 imputed stocks
- v0.18 SPEC_42 - theme_strength
- **v0.19 SPEC_40 - fitness_signal_60d - theme_is_semiconductor**(最嚴格 / strictest)

**Empirical 反論(corrective bundle III)**:嚴格不損 model 表現,反而 LightGBM ded +0.64 / CatBoost ded +0.39 / RF Win 100% — **doctrine purity → 更乾淨 signal**
